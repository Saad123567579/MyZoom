...
const Mymeeting = () => {
  ...
  return (
    <>
      {mymeetings === null && <div className='h-full w-full font-bold flex justify-center items-center text-4xl'>Loading...</div>}
      {mymeetings?.length === 0 && <><Navbar /><div className='h-full w-full font-bold flex justify-center items-center text-4xl'>No Meetings Found</div></>}
